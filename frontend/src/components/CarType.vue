<template>
  <div class="car_type">
    ...
    <v-tabs 
      ...
      centered
    >
      <v-tab href="#TOYOTA" class="font_style">TOYOTA</v-tab>
      <v-tab href="#HONDA" class="font_style">HONDA</v-tab>
      <v-tab href="#MAZDA" class="font_style">MAZDA</v-tab>
    </v-tabs>
    <v-tabs-items v-model="model">
      <v-tab-item value=TOYOTA>
